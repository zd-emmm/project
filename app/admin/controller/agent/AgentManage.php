...
use tools\services\UploadService;
...
class AgentManage extends AuthController
{
    ...
    public function index()
    {
        ...
        $this->assign('store_brokerage_statu',\tools\services\SystemConfigService::get('store_brokerage_statu'));
        return $this->fetch();
    }
    ...
    * */
    ...
    {
        $qr_code = \tools\services\QrcodeService::getTemporaryQrcode('spread',$uid);
