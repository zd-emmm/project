...
<div id="wrapper">
                ...
                <li class="nav-header">
                    <div class="dropdown profile-element admin_open">
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            ...
                            <li><a class="admin_close" target="_blank" href="http://www.yiliit.com/">联系我们</a>
                            </li>
                            <li class="divider"></li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe_qolai_main" width="100%" height="100%" src="{:Url('Index/main')}" frameborder="0" data-id="{:Url('Index/main')}" seamless></iframe>
        </div>
        <!--底部版权-->
        <div class="footer"  @touchmove.prevent>
            <div class="pull-right">© 2020-2022 <a href="http://www.yiliit.com/" target="_blank">某某购物</a>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
