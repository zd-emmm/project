...
return [
    ...
    'listen'    => [
        ...
        'WechatMessageBefore' => [], // MessageSubscribe 微信消息前置操作  tools\services\WechatService
        'WechatEventUnsubscribeBefore' => [], // MessageSubscribe 用户取消关注公众号前置操作  tools\services\WechatService
    ...
    'subscribe' => [
        tools\subscribes\SystemSubscribe::class,
        tools\subscribes\OrderSubscribe::class,
        tools\subscribes\ProductSubscribe::class,
        tools\subscribes\UserSubscribe::class,
        tools\subscribes\MaterialSubscribe::class,
        tools\subscribes\MessageSubscribe::class,
        tools\subscribes\TaskSubscribe::class,
    ],
];
