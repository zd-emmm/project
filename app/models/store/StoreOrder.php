...
use tools\repositories\GoodsRepository;
use tools\repositories\PaymentRepositories;
use tools\services\ApiLogs;
use app\models\user\User;
use app\models\user\UserAddress;
use app\models\user\UserBill;
use app\models\user\WechatUser;
use tools\basic\BaseModel;
use tools\repositories\OrderRepository;
use tools\services\CustomerService;
use tools\services\MiniProgramService;
use tools\services\SystemConfigService;
use tools\services\WechatService;
use tools\services\WechatTemplateService;
use tools\services\workerman\ChannelService;
...
//        ]);
    ...
    public static function orderTakeAfter($order)
    {
        ...
        if ($order['is_channel']) {//小程序
            ...
            \tools\services\WechatTemplateService::sendTemplate($openid, \tools\services\WechatTemplateService::ORDER_TAKE_SUCCESS, [
                'first' => '亲，您的订单已收货',
                'keyword1' => $order['order_id'],
                'keyword2' => '已收货',
    ...
    public static function tidyOrder($order, $detail = false, $isPic = false)
    {
        ...
        //获取产品状态图片
        if ($isPic) {
            $order_details_images = \tools\services\GroupDataService::getData('order_details_images') ?: [];
