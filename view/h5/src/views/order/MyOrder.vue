<template>
  <div class="my-order" ref="container">
    <div class="header bg-color-yellow">
      ...
      <div class="item" v-for="order in orderList" :key="order.id">
        ...
        <div class="bottom acea-row row-right row-middle">
          <template v-if="order._status._type === 0">
            ...
            <div class="bnt bg-color-yellow" @click="paymentTap(order)">
              立即付款
            </div>
          </template>
          <template
          ...
          <template v-if="order._status._type === 2">
            ...
            <div class="bnt bg-color-yellow" @click="takeOrder(order)">
              确认收货
            </div>
          </template>
