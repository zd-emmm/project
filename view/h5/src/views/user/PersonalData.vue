<template>
  <div class="personal-data">
    <div class="wrapper">
      ...
      <div class="wrapList">
        ...
        >
          ...
          <div
            class="currentBnt acea-row row-center-wrapper font-color-yellow"
            v-if="item.uid === userInfo.uid"
          >
            当前账号
          </div>
          <div
            class="bnt font-color-yellow acea-row row-center-wrapper"
            v-else
    ...
    <div class="modifyBnt bg-color-yellow" @click="submit">保存修改</div>
    <div
